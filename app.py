...
# You can create a new .db file by running `sqlite3 new.db < create_table.sql`
...
# The variable `start_time` is used to keep track of time.
# The variable `previous_path` is used to keep track of what the user visited before requesting the current page.
