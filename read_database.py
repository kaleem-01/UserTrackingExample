# This programme converts a .db file to a .csv file for your convenience
# Change the "path" variable according to your directory
# Change the name of the .db file 
...
path = 'C:/Users/gaktas/Desktop/Example/'
